...
- Sixteen donor-supply mappings covering UDP-GlcNAc/GalNAc, UDP-Hexose/Gal,
  UDP-GlcA, GDP-Mannose, GDP-Fucose, and CMP-Sialic acid donor supply:
  12 independent core mappings plus 4 model-alternative or
  compartment-duplicate mappings
...
- Glycosylation donor-supply dictionary coverage increased from 0 to 16 raw
  mapped reactions, with 12 effective independent core mappings
...
- Full-FVA validation completed with `full_fva / all / broad_discovery`;
  practice_20aa steps 10-14 passed
- Donor-supply audit reports 16 model reactions, 16 raw mappings, 12 effective
  independent core mappings, and 4 model-alternative/duplicate mappings
- Fig14 and its companion CSV were generated with full-FVA provenance
